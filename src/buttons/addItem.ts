...
import { ComponentType, Message, ModalBuilder, RoleSelectMenuBuilder, TextInputBuilder, TextInputStyle } from "discord.js";
...
export default new ButtonHandler({
    ...
    const modalRep = await typeRep.awaitModalSubmit({
        time: 300000
    }).catch(log4js.trace)
